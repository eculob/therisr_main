        ...
        try {
          ...
          if(!empty($request->stripeToken) && empty($request->customerId)){
                  ...
                  'address' => [
                      ...
                      'postal_code' => '98140',
                      'city' => (Auth::user()->user_type == 1) ? (!empty(Auth::user()->userProfile->city) ? Auth::user()->userProfile->city : 'N' ): (!empty(Auth::user()->userEmpProfile->city) ? Auth::user()->userEmpProfile->city : ''),
                      'state' => 'CA',
