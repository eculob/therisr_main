...
class FilterController extends Controller
{
    ...
    function filter_apply_free(Request $request){
      ...
      if(!empty($request->type) && $request->type == 'save'){
        ...
        if(!empty($total_cost) && $request->total_cost != 'any' && $request->total_cost != '')
        {
       ...
       $experience = explode(',', $request->experience);
        if(!empty($experience) && $request->experience != 'any' && $request->experience != '')
        {
        ...
        if(!empty($weekly_limit) && $request->weekly_limit != 'any' && $request->weekly_limit != '' )
        {
        ...
        if(!empty($project_length) && $request->project_length != 'any' && $request->project_length != '')
        {
    ...
    function filter_apply_emp(Request $request){
      ...
      if(!empty($request->type) && $request->type == 'save'){
        ...
        if(!empty($hourly_rate) && $request->hourly_rate != 'any' && $request->hourly_rate != '')
        {
        ...
        if(!empty($availability) && $request->availability != 'any' && $request->availability != '')
        {
        ...
        if(!empty($therisr_score) && $request->therisr_score != 'any' && $request->therisr_score != '')
        {
        ...
        if(trim($request->searchInput) != ''){
          $users_result = $users_result->where('name', 'like', '%' . $request->searchInput . '%');
            $f_query = UserProfile::select('user_id')
