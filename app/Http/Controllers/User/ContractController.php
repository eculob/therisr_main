...
class ContractController extends Controller
{
    ...
    { 
        ...
        if($page == 'endedcontract' || $page == 'e_endedcontract')
        { 
            $contracts =  JobContract::where(array(
          ...
          if($type == 'reject')
          {
              ...
              if ($done) {
               ...
               echo json_encode(array('code'=>500,'message'=>'Oops! Something wrong.'));
                ...
                if ($contract->trashed()) {
                  // delete proposals
                  JobProposals::where('job_id', $contractJobId)->delete();
               ...
               $contractJobId =  $contract->job_id;
                ...
                if ($contract->restore()) {
                  ...
                  // restore proposals as well
                  JobProposals::where('job_id', $contractJobId)->restore();
