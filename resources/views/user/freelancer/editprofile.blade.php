            ...
            <label for="img-str" class="btm-drgs">
               ...
               <div class="dropdown">
                  <button class="btn btn-secondary dropdown-toggle select-p" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     ...
                     <p>Recommended image size 1300X400</p>
                  </button>
                  ...
                  <div class="inner-txt-cont profilrmrt">
                     ...
                     <div class="accordion tabs-fll-w" id="accordionExample">
                        ...
                        <div class="card">
                           ...
                           <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                             <form class="personalForm" method="POST" name="personalForm">
                              @csrf
                              <div class="card-body">
                                 <div class="padding-srt scrollArea">
                                    <div class="row">
                        ...
                        <div class="card work-experince">
                           <div class="card-header" id="headingThree" onclick="get_workExpBOX();get_eduBOX();">
                              <h2 class="mb-0">
                        ...
                        <div class="card">
                           <div class="card-header" id="headingThree1" onclick="get_socialBOX();">
                              <h2 class="mb-0">
       ...
       reader.onload = function(e) {
            ...
            image.onload = function() {
              ...
              height = this.height;
                ...
                if(width < 1300 || height < 400){
                       $.toast({
                       heading: 'Error',
                       text:'Dimensions should be at least 1300x400',
                       showHideTransition: 'slide',
                       icon: 'error'
                     });
                }else{
