   ...
   <div class="freelancing-landing-page text-center pos-rel">
      <div class="container-fluid">
         <div class="row">
            <div class="col-lg-7 col-md-7 col-sm-6 srch-bord-res filter-inline">
               <form class="form-inline md-form form-sm form-filter-freelancer">
         ...
         <div class="container-fluid pl-4 pr-4">
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  <a href="javascript:void(0);" onclick="applyFilter();" class="btn-cntrs"> Apply Filters </a>
               </div>
            </div>
         </div>
      </div>
    ...
    if(url != ''){
     ...
     $url =  "{{ route('user.filter_apply_free') }}"
      ...
      ajaxCall =  $.ajax({
            ...
            type: 'POST',
            data: {
               services : ($('#services_filter').val() != null) ? $('#services_filter').val().join(',') : '',
