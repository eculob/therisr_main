            ...
            @endphp
              ...
              <div class="freelanDetails">
                 <div class="nameTitle">
                    ...
                    <p>
                      {{ (!empty($user->userProfile['hourly_rate']) ?
                        (!empty($settings->currency)  ? $settings->currency  : '$').$user->userProfile['hourly_rate'].'/hr' : '') }}
                    </p>

                    <p>
                      <img src="{{ asset('../assets/img/location-cream.png') }}" alt="">
                 ...
                 <p class="coverTxt">
                  ...
                  {{ (!empty($user->userProfile['prim_title']) && !empty($user->userProfile['sec_title']) ) ? '/' : ''}} {{ !empty($user->userProfile['sec_title']) ? $user->userProfile['sec_title'] : '' }}
                 </p>
