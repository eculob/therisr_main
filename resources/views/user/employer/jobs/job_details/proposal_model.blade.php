...
<div class="modal-header">
            ...
            <ul class="vew-pfle-ul">
              ...
              @endif
                ...
                <?php
                    $jobId = !empty($proposal->jobDetail->id) ? $proposal->jobDetail->id : '';
                    $freelancerId =!empty( $proposal->userBasicDetail->id) ?  $proposal->userBasicDetail->id : '';
                ?>
               ...
               <div class="media-body">
                  <div class="vew-prfle-rate">
                     ...
                     <ul>
                        ...
                        <li>
                           <img src="{{ asset('../assets/img/location-cream.png') }}"> {{ !empty($proposal->userBasicDetail->countryName['country_name'] ) ? $proposal->userBasicDetail->countryName['country_name']  : ''}}
                        </li>
                     </ul>
                  </div>
            ...
            <div class="modl-qulfs">
               ...
               <ul>
                  ...
                  <li class="modl-port-rel">TheRisr score
                     <!--<i class="fa fa-thumbs-o-up thumb-bage" aria-hidden="true"></i>-->
                     <span>{{ !empty($proposal->userBasicDetail->therisr_score) ? ($proposal->userBasicDetail->therisr_score) : '0.00'}} </span>
                  </li>
